$_mod.def("/marko$4.21.7/src/runtime/components/registry-browser", function(require, exports, module, __filename, __dirname) { var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var defineComponent = require('/marko$4.21.7/src/runtime/components/defineComponent'/*"./defineComponent"*/);
var loader = require('/marko$4.21.7/src/loader/index-browser'/*"../../loader"*/);
require('/marko$4.21.7/src/runtime/components/index-browser'/*"."*/);
