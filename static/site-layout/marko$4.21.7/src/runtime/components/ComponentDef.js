$_mod.def("/marko$4.21.7/src/runtime/components/ComponentDef", function(require, exports, module, __filename, __dirname) { "use strict";
...
var componentUtil = require('/marko$4.21.7/src/runtime/components/util-browser'/*"./util"*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var addDelegatedEventHandler = require('/marko$4.21.7/src/runtime/components/event-delegation'/*"./event-delegation"*/)
  .___addDelegatedEventHandler;
var extend = require('/raptor-util$3.2.0/extend'/*"raptor-util/extend"*/);
var KeySequence = require('/marko$4.21.7/src/runtime/components/KeySequence'/*"./KeySequence"*/);
var EMPTY_OBJECT = {};
