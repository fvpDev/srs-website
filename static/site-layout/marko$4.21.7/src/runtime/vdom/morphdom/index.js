$_mod.def("/marko$4.21.7/src/runtime/vdom/morphdom/index", function(require, exports, module, __filename, __dirname) { "use strict";
var specialElHandlers = require('/marko$4.21.7/src/runtime/vdom/morphdom/specialElHandlers'/*"./specialElHandlers"*/);
var KeySequence = require('/marko$4.21.7/src/runtime/components/KeySequence'/*"../../components/KeySequence"*/);
var componentsUtil = require('/marko$4.21.7/src/runtime/components/util-browser'/*"../../components/util"*/);
...
var VElement = require('/marko$4.21.7/src/runtime/vdom/vdom'/*"../vdom"*/).___VElement;
var virtualizeElement = VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.21.7/src/runtime/components/event-delegation'/*"../../components/event-delegation"*/);
var fragment = require('/marko$4.21.7/src/runtime/vdom/morphdom/fragment'/*"./fragment"*/);
var helpers = require('/marko$4.21.7/src/runtime/vdom/morphdom/helpers'/*"./helpers"*/);
var domData = require('/marko$4.21.7/src/runtime/components/dom-data'/*"../../components/dom-data"*/);
