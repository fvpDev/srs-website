$_mod.def("/marko$4.21.7/src/runtime/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.21.7/src/runtime/components/util-browser'/*"./util"*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.21.7/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/);
...
var beginComponent = require('/marko$4.21.7/src/runtime/components/beginComponent-browser'/*"./beginComponent"*/);
var endComponent = require('/marko$4.21.7/src/runtime/components/endComponent-browser'/*"./endComponent"*/);
