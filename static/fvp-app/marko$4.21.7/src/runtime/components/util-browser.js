$_mod.def("/marko$4.21.7/src/runtime/components/util-browser", function(require, exports, module, __filename, __dirname) { var domData = require('/marko$4.21.7/src/runtime/components/dom-data'/*"./dom-data"*/);
