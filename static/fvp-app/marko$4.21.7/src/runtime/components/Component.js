$_mod.def("/marko$4.21.7/src/runtime/components/Component", function(require, exports, module, __filename, __dirname) { "use strict";
/* jshint newcap:false */

var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);

var domInsert = require('/marko$4.21.7/src/runtime/dom-insert'/*"../dom-insert"*/);
var defaultCreateOut = require('/marko$4.21.7/src/runtime/createOut'/*"../createOut"*/);
var getComponentsContext = require('/marko$4.21.7/src/runtime/components/ComponentsContext'/*"./ComponentsContext"*/)
  .___getComponentsContext;
var componentsUtil = require('/marko$4.21.7/src/runtime/components/util-browser'/*"./util"*/);
...
var RenderResult = require('/marko$4.21.7/src/runtime/RenderResult'/*"../RenderResult"*/);
...
var updateManager = require('/marko$4.21.7/src/runtime/components/update-manager'/*"./update-manager"*/);
var morphdom = require('/marko$4.21.7/src/runtime/vdom/morphdom/index'/*"../vdom/morphdom"*/);
var eventDelegation = require('/marko$4.21.7/src/runtime/components/event-delegation'/*"./event-delegation"*/);
var domData = require('/marko$4.21.7/src/runtime/components/dom-data'/*"./dom-data"*/);
